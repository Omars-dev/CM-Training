        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="industrial-courses-header box">
                    <h2 class="text-capitalize" style="margin-bottom: 40px">Civil & Architecture Technology</h2>
                    <p>
                        এই কোর্সটি Civil & Architecture Technology প্রায়শই বিশ্বস্ত ধারণা নিয়ে অবলম্বন করে। এটি শিল্পগত অ্যাটাচমেন্টের জন্য প্রস্তুততার জন্য দ্রুত প্রয়োজনীয় দক্ষতা এবং স্কিল সরবরাহ করে। এই কোর্সটি ক্রিয়েটিভ মনোযোগ, নতুন স্থাপত্য প্রকল্পের উদ্ভাবন এবং কার্যকলাপে আপনার জ্ঞান এবং দক্ষতা প্রসারিত করবে।
                    </p>
                </div>
                <!-- End Courses header -->
            ...
            <div class="col-lg-5">
                ...
                <div class="course-slider box" style="background-color: #FFEFDF;border-radius: 8px;">
                    ...
                    <ul class="course-features-list">
                        ...
                        <li>Construction site visit for civil engineer</li>
