            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="courses-header box" style="background-color: #FFEFDF;">
                        <h2 class="text-capitalize">Routing & Switching</h2>
                        <div class="rating">
                            ...
                            <span class="reviews">(130 Reviews)</span>
                        </div>
                        <ul>
                            <li>enrolled students - <span>20</span></li>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-2">
                                        <i class="fa fa-angle-left control-icon"></i> Cisco Certified Network Associate (CCNA)
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-3"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> CCNP ENCORE
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-4"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> CCNP ENARSI
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-5"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> MikroTik Certified Network Administrator (MTCNA)
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-6"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> MikroTik Certified Routing Engineer (MTCRE)
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-7"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> MikroTik With ISP Setup
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-8"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> FTTx & OLT (V-SOL/BDCOM/C-DATA)
                                    </a>
                                </h4>
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="course-slider box" style="background-color: #FFEFDF;">
                        ...
                        <ul class="course-features-list">
                            ...
                            <li>MikroTik With ISP Setup</li>
                            <li>FTTx & OLT (V-SOL/BDCOM/C-DATA)</li>
                        </ul>
                        <div class="btn-wrap">
