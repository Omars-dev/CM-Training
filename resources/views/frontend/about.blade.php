    ...
    <section id="about-section" class="about-section">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="about-img">
                        <img src="{{url('frontend/images/user-2.png')}}" class="img-responsive" alt="About images">
                        <div class="head-text">
            ...
            <div class="row">
                <div class="col-md-3 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="300ms">
                    <div class="team-member">
                        <img src="{{url('frontend/images/team/team.jpg')}}" class="img-responsive" alt="">
                ...
                <div class="col-md-12">
                    <div class="client-box">
                        <ul class="client-list">
                            <li><a href="#"><img src="{{url('frontend/images/clients/client1.png')}}" class="img-responsive"
                                        alt="Clients Logo"></a></li>
                            <li><a href="#"><img src="{{url('frontend/images/clients/client2.png')}}" class="img-responsive"
                                        alt="Clients Logo"></a></li>
                            <li><a href="#"><img src="{{url('frontend/images/clients/client3.png')}}" class="img-responsive"
                                        alt="Clients Logo"></a></li>
                            <li><a href="#"><img src="{{url('frontend/images/clients/client4.png')}}" class="img-responsive"
                                        alt="Clients Logo"></a></li>
                            <li><a href="#"><img src="{{url('frontend/images/clients/client5.png')}}" class="img-responsive"
                                        alt="Clients Logo"></a></li>
                        </ul>
                    </div>
                </div>
