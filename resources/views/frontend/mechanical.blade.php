        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="industrial-courses-header box">
                    <h2 class="text-capitalize" style="margin-bottom: 40px">Mechanical Technology</h2>
                    <p>
                        "ইন্ডাস্ট্রিয়াল অ্যাটাচমেন্টের জন্য মেকানিক্যাল টেকনোলজি কোর্স" মেকানিক্যাল ইঞ্জিনিয়ারিং নীতি ও অনুশীলনের ব্যাপক প্রশিক্ষণ প্রদান করে, বিশেষ করে শিল্প সংযুক্তির জন্য তৈরি। এই কোর্সটি শিক্ষার্থীদের বাস্তব-বিশ্ব শিল্প সেটিংসে যান্ত্রিক তত্ত্ব প্রয়োগ করার জন্য প্রয়োজনীয় দক্ষতা এবং জ্ঞান দিয়ে সজ্জিত করে।
                    </p>
                </div>
                <!-- End Courses header -->
