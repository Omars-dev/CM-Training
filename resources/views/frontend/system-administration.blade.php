            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="courses-header box" style="background-color: #FFEFDF;">
                        <h2 class="text-capitalize">System Administration</h2>
                        <div class="rating">
                        ...
                        <ul>
                            <li>enrolled students - <span>50</span></li>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-2">
                                        <i class="fa fa-angle-left control-icon"></i> Windows Server 2019/2022
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-3"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> RedHat Certified System Administrator (RHCSA) 
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-4"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> RedHat Certified  Engineer (RHCE)
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-5"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> Microsoft Azure-104
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-6"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> Amazon Web Service (AWS)
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-7"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> Office 365 Administration 
                                    </a>
                                </h4>
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="course-slider box" style="background-color: #FFEFDF;">
                        <div class="img-box">
                            <img src="images/courses/outsourcing-1.jpeg" alt="">
                            <div class="play-icon">
                        ...
                        <ul class="course-features-list">
                            ...
                            <li>RedHat Certified  Engineer (RHCE)</li>
                            <li>Microsoft Azure-104</li>
