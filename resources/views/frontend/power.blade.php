        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="industrial-courses-header box">
                    <h2 class="text-capitalize" style="margin-bottom: 40px">Power Technology</h2>
                    <p>
                        কোর্সটি ইন্ডাস্ট্রিয়াল অ্যাটাচমেন্টের জন্য একটি কোর্স যা উদ্ভাবনশীল Power Technology বিষয়ে শিক্ষার্থীদের সুযোগ দেয়। এই কোর্সে পাওয়া যাবে Power Technology পরিচিতি, বিভিন্ন প্রযুক্তি উপকরণের ব্যবহার, বিভিন্ন উপকরণের কার্যকারিতা এবং অতিরিক্ত কার্যক্ষেত্রের সম্ভাব্য অবসরপ্রাপ্তি সম্পর্কিত জ্ঞান। এই কোর্স আপনাকে উচ্চস্তরের কর্মসংস্থানে একটি সুযোগ প্রদান করতে সক্ষম করবে।
                    </p>
                </div>
                <!-- End Courses header -->
