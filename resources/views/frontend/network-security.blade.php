    ...
    <section class="courses-deatils section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <!-- Courses header -->
                    <div class="courses-header box" style="background-color: #FFEFDF;">
                        <h2 class="text-capitalize">Network Security</h2>
                        <div class="rating">
                            ...
                            <span class="reviews">(630 Reviews)</span>
                        </div>
                        <ul>
                            <li>enrolled students - <span>550</span></li>
                            <li>created by - <span>Md. Alomgir Hossain</span></li>
                    ...
                    <div class="tab-content">
                        <div id="course-curriculum" class="tab-pane fade in active" style="background-color: #FFEFDF;">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-2">
                                        <i class="fa fa-angle-left control-icon"></i> Cisco CCNP SCORE
                                        <!-- <span style="float: right; margin-right: 20px;">Length: 40 hours</span> -->
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-3"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> Cyber Security & Ethical Hacking
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-4"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> Cisco CyberOps
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-5"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> PaloAlto Firewall Administration
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-6"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> Fortinet FortiGate Firewall (NSE4)
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-7"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> OSCP Penetration Testing
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-8"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> SOC Analyst
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse-9"
                                        class="collapsed">
                                        <i class="fa fa-angle-left control-icon"></i> Certified Cloud Security Professional
                                    </a>
                                </h4>
                            </div>
                    ...
                    <!-- End Accordion section -->
                        ...
                        <div id="course-description" class="tab-pane fade" style="background-color: #FFEFDF;">
                        ...
                        <div id="course-instructor" class="tab-pane fade" style="background-color: #FFEFDF;">
                        ...
                        <div id="course-reviews" class="tab-pane fade" style="background-color: #FFEFDF;">
                ...
                <div class="col-lg-4">
                    <!-- course slider -->
                    <div class="course-slider box" style="background-color: #FFEFDF;">
                        <div class="img-box">
                        ...
                        <ul class="course-features-list">
                            <li>Cisco CCNP SCORE</li>
                            <li>Cyber Security & Ethical Hacking</li>
                            <li>Cisco CyberOps</li>
                            <li>PaloAlto Firewall Administration</li>
                            <li>Fortinet FortiGate Firewall (NSE4)</li>
                            <li>OSCP Penetration Testing</li>
                            <li>SOC Analyst</li>
